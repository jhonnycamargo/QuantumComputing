...
#line hidden
            {
#line 9 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
                var q = Allocate__.Apply();
#line hidden
                bool __arg1__ = true;
                try
                {
#line 10 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
                    Microsoft__Quantum__Intrinsic__H.Apply(q);
#line 11 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
...
#line hidden
    ...
    [SourceLocation("E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs", OperationFunctor.Body, 15, 28)]
    public partial class SampleRandomNumberInRange : Operation<(Int64,Int64), Int64>, ICallable
    {
        ...
        {
            var (max,min) = __in__;
#line 16 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
            var output = 0L;
#line 17 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
            while (true)
            {
#line 18 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
                var bits = QArray<Result>.Create(0L);
#line 19 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
                foreach (var idxBit in new QRange(1L, Microsoft__Quantum__Math__BitSizeI.Apply(max)))
#line hidden
                {
#line 20 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
                    bits = QArray<Result>.Add(bits, new QArray<Result>(GenerateRandomBit__.Apply(QVoid.Instance)));
                }

#line 22 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
...
#line 24 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
            return output;
        }
    ...
    [SourceLocation("E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs", OperationFunctor.Body, 28, -1)]
    public partial class SampleRandomNumber : Operation<QVoid, Int64>, ICallable
    {
        ...
        {
#line 29 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
            var max = 50L;
#line 30 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
            var min = 10L;
#line 31 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
            Message__.Apply(String.Format("Sampling a random number between {0} and {1}: ", min, max));
#line 32 "E:\\Dev\\Quantum\\Projects\\QuantumRNG\\Program.qs"
